...
import { additionalInfo2 } from "@/data/CV/additionalInformations2";

export default function AdditionalInfoPage2() {
  return (
    <BookPage>
      <motion.div
      ...
      >
        ...
        <div className="mb-6">
          ...
          <div className="space-y-2">
            {additionalInfo2.technicalSkills.map((skillGroup, idx) => (
              <div key={idx}>
        ...
        <div>
          ...
          <ul className="list-disc list-inside text-gray-700 text-sm ml-4 space-y-1">
            {additionalInfo2.softSkills?.map((skill, i) => (
              <li key={i}>{skill}</li>
            ))}
          </ul>
        </div>
